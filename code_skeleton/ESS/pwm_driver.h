...
// initialize pwm driver. This assumers that led_init() has been previously called for
...
*
* @warning this assums that pwm_driver_init() has been called for each channel before this function is called.
*
* No return
*/
